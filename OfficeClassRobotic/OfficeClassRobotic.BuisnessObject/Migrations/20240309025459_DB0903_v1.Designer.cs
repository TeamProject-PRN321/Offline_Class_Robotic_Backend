...
namespace OfficeClassRobotic.BuisnessObject.Migrations
{
    ...
    [Migration("20240309025459_DB0903_v1")]
    partial class DB0903_v1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("04a40034-c64c-43c2-8991-86cea9be3427"),
                            AppUserId = new Guid("da053af4-cdf1-4a6b-8506-2e3939ef6351"),
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(3828),
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Gender = "Male",
                            PassWordHash = new byte[] { 9, 40, 74, 6, 71, 145, 21, 153, 54, 54, 59, 12, 227, 90, 120, 93, 78, 146, 146, 155, 165, 124, 25, 152, 177, 73, 209, 6, 107, 95, 174, 67, 114, 224, 232, 86, 229, 152, 52, 3, 55, 248, 185, 32, 191, 226, 0, 69, 18, 19, 152, 207, 217, 98, 178, 145, 178, 110, 127, 33, 63, 211, 174, 195 },
                            PassWordSalt = new byte[] { 96, 242, 124, 253, 135, 152, 64, 0, 35, 80, 175, 240, 47, 2, 171, 75, 145, 3, 128, 54, 28, 205, 129, 135, 114, 248, 194, 99, 62, 103, 0, 144, 108, 47, 78, 144, 51, 175, 71, 82, 222, 181, 188, 94, 106, 240, 67, 32, 109, 26, 104, 241, 117, 57, 143, 121, 206, 55, 109, 125, 155, 34, 2, 73, 242, 185, 51, 208, 84, 130, 17, 103, 223, 47, 26, 126, 45, 117, 102, 123, 24, 240, 163, 128, 15, 207, 185, 140, 33, 106, 95, 159, 160, 137, 54, 180, 27, 25, 186, 141, 61, 255, 57, 158, 83, 35, 101, 203, 49, 251, 17, 161, 97, 229, 154, 129, 16, 116, 98, 192, 87, 105, 103, 105, 145, 247, 31, 194 },
                        ...
                        new
                        {
                            ...
                            Gender = "Male",
                            PassWordHash = new byte[] { 3, 139, 63, 194, 238, 165, 26, 131, 229, 91, 64, 197, 217, 205, 151, 133, 42, 45, 76, 0, 92, 101, 144, 220, 188, 53, 61, 204, 119, 182, 62, 131, 65, 174, 172, 253, 86, 204, 188, 60, 162, 85, 191, 202, 15, 69, 177, 12, 168, 92, 157, 48, 245, 237, 4, 84, 11, 179, 207, 70, 212, 233, 3, 105 },
                            PassWordSalt = new byte[] { 96, 242, 124, 253, 135, 152, 64, 0, 35, 80, 175, 240, 47, 2, 171, 75, 145, 3, 128, 54, 28, 205, 129, 135, 114, 248, 194, 99, 62, 103, 0, 144, 108, 47, 78, 144, 51, 175, 71, 82, 222, 181, 188, 94, 106, 240, 67, 32, 109, 26, 104, 241, 117, 57, 143, 121, 206, 55, 109, 125, 155, 34, 2, 73, 242, 185, 51, 208, 84, 130, 17, 103, 223, 47, 26, 126, 45, 117, 102, 123, 24, 240, 163, 128, 15, 207, 185, 140, 33, 106, 95, 159, 160, 137, 54, 180, 27, 25, 186, 141, 61, 255, 57, 158, 83, 35, 101, 203, 49, 251, 17, 161, 97, 229, 154, 129, 16, 116, 98, 192, 87, 105, 103, 105, 145, 247, 31, 194 },
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.Class", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClassName = "SE1603",
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(4094),
                        ...
                        new
                        {
                            Id = new Guid("f29374fd-d88e-46cc-9290-0f1ca57c8f03"),
                            ClassName = "How to Make an Array and it's Type in JAVA",
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(4111),
                            DayStudy = "Thứ 3;Thứ 6",
                            EndTime = new TimeSpan(0, 18, 0, 0, 0),
                            IsClassFinish = false,
                            IsDeleted = false,
                            StartTime = new TimeSpan(0, 15, 0, 0, 0),
                        ...
                        new
                        {
                            Id = new Guid("e258364f-8a4a-4e51-b816-29d9067c814f"),
                            ClassName = "How to Make an Array and it's Type in C#",
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(4120),
                            DayStudy = "Thứ 4;Thứ 7",
                            EndTime = new TimeSpan(0, 18, 0, 0, 0),
                            IsClassFinish = false,
                            IsDeleted = false,
                            StartTime = new TimeSpan(0, 15, 0, 0, 0),
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.ClassSchedule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 192, DateTimeKind.Local).AddTicks(4939),
                            DateStudy = new DateTime(2024, 3, 9, 9, 54, 59, 192, DateTimeKind.Local).AddTicks(4940),
                            IsDeleted = false,
                            NumberOfSudent = 40,
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.Classroom", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClassRoomName = "P.403",
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(4005),
                        ...
                        new
                        {
                            ...
                            ClassRoomName = "P.303",
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(4009),
                        ...
                        new
                        {
                            ...
                            ClassRoomName = "P.203",
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(4012),
                        ...
                        new
                        {
                            ...
                            ClassRoomName = "P.103",
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(4016),
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.GiaoTrinh", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 192, DateTimeKind.Local).AddTicks(4697),
                            Description = "",
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 192, DateTimeKind.Local).AddTicks(5188),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(3954),
                            IsDeleted = false,
                            ParentId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(3957),
                            IsDeleted = false,
                            ParentId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(3959),
                            IsDeleted = false,
                            ParentId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            ...
                            AppUserId = new Guid("5ddd65ff-16a1-4fd1-acbf-c913f0cce37c"),
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(3965),
                            IsDeleted = false,
                            ParentId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(3968),
                            IsDeleted = false,
                            ParentId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(3971),
                            IsDeleted = false,
                            ParentId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(3974),
                            IsDeleted = false,
                            ParentId = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.Subject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 192, DateTimeKind.Local).AddTicks(4900),
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.Teacher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(4045),
                            IsDeleted = false
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(4049),
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.TrungTamRobotic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 192, DateTimeKind.Local).AddTicks(4989),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("OfficeClassRobotic.BuisnessObject.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(3864),
                            IsDeleted = false,
                            RoleName = "Student"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(3869),
                            IsDeleted = false,
                            RoleName = "Parent"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(3873),
                            IsDeleted = false,
                            RoleName = "Staff"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(3875),
                            IsDeleted = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(3878),
                            IsDeleted = false,
                            RoleName = "Teacher"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 9, 9, 54, 59, 193, DateTimeKind.Local).AddTicks(3881),
                            IsDeleted = false,
