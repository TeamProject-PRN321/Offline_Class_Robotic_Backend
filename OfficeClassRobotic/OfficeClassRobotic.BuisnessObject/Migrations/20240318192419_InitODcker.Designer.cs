...
namespace OfficeClassRobotic.BuisnessObject.Migrations
{
    ...
    [Migration("20240318192419_InitODcker")]
    partial class InitODcker
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("57eee92c-7b44-4388-a079-f08bdf2bcb10"),
                            AppUserId = new Guid("da053af4-cdf1-4a6b-8506-2e3939ef6351"),
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9663),
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Gender = "Male",
                            PassWordHash = new byte[] { 233, 143, 64, 151, 152, 189, 62, 228, 232, 157, 246, 197, 207, 37, 66, 100, 46, 108, 20, 33, 203, 173, 239, 135, 196, 132, 236, 107, 197, 145, 215, 250, 21, 78, 81, 19, 206, 15, 11, 32, 89, 179, 52, 76, 35, 176, 125, 72, 64, 66, 81, 148, 131, 136, 51, 180, 173, 90, 144, 0, 237, 191, 77, 18 },
                            PassWordSalt = new byte[] { 188, 16, 249, 135, 150, 134, 181, 14, 221, 207, 167, 209, 123, 32, 216, 161, 162, 103, 218, 217, 207, 220, 210, 139, 255, 65, 27, 75, 108, 86, 207, 123, 94, 236, 42, 139, 252, 90, 223, 146, 105, 20, 70, 0, 154, 64, 133, 180, 31, 24, 68, 18, 89, 188, 239, 121, 174, 156, 51, 129, 65, 32, 116, 254, 91, 33, 201, 45, 206, 92, 55, 210, 70, 58, 57, 80, 56, 248, 68, 229, 150, 223, 35, 7, 133, 159, 158, 163, 27, 22, 194, 16, 31, 53, 97, 158, 5, 173, 228, 165, 120, 240, 120, 3, 203, 202, 22, 150, 64, 15, 57, 86, 120, 0, 165, 244, 194, 184, 108, 52, 31, 107, 142, 129, 189, 214, 51, 179 },
                        ...
                        new
                        {
                            ...
                            Gender = "Male",
                            PassWordHash = new byte[] { 90, 237, 48, 182, 28, 120, 18, 247, 169, 157, 213, 222, 190, 62, 141, 7, 134, 129, 94, 38, 70, 121, 23, 239, 73, 90, 197, 169, 228, 250, 255, 0, 179, 182, 197, 109, 170, 234, 197, 226, 226, 86, 248, 41, 244, 154, 14, 34, 47, 0, 221, 227, 98, 209, 158, 19, 131, 169, 9, 133, 245, 158, 57, 244 },
                            PassWordSalt = new byte[] { 188, 16, 249, 135, 150, 134, 181, 14, 221, 207, 167, 209, 123, 32, 216, 161, 162, 103, 218, 217, 207, 220, 210, 139, 255, 65, 27, 75, 108, 86, 207, 123, 94, 236, 42, 139, 252, 90, 223, 146, 105, 20, 70, 0, 154, 64, 133, 180, 31, 24, 68, 18, 89, 188, 239, 121, 174, 156, 51, 129, 65, 32, 116, 254, 91, 33, 201, 45, 206, 92, 55, 210, 70, 58, 57, 80, 56, 248, 68, 229, 150, 223, 35, 7, 133, 159, 158, 163, 27, 22, 194, 16, 31, 53, 97, 158, 5, 173, 228, 165, 120, 240, 120, 3, 203, 202, 22, 150, 64, 15, 57, 86, 120, 0, 165, 244, 194, 184, 108, 52, 31, 107, 142, 129, 189, 214, 51, 179 },
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.Class", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClassName = "SE1603",
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9924),
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.ClassSchedule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(475),
                            DateStudy = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(477),
                            IsDeleted = false,
                            NumberOfSudent = 40,
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.Classroom", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClassRoomName = "P.403",
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9846),
                        ...
                        new
                        {
                            ...
                            ClassRoomName = "P.303",
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9851),
                        ...
                        new
                        {
                            ...
                            ClassRoomName = "P.203",
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9854),
                        ...
                        new
                        {
                            ...
                            ClassRoomName = "P.103",
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9856),
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.Device", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClassRoomId = new Guid("d2e283a6-5bf5-4d27-a2c2-994cb6d781e9"),
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9969),
                        ...
                        new
                        {
                            ...
                            ClassRoomId = new Guid("d2e283a6-5bf5-4d27-a2c2-994cb6d781e9"),
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9978),
                        ...
                        new
                        {
                            ...
                            ClassRoomId = new Guid("d2e283a6-5bf5-4d27-a2c2-994cb6d781e9"),
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9981),
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.GiaoTrinh", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(418),
                            Description = "",
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(725),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9761),
                            IsDeleted = false,
                            ParentId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9765),
                            IsDeleted = false,
                            ParentId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9768),
                            IsDeleted = false,
                            ParentId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            ...
                            AppUserId = new Guid("5ddd65ff-16a1-4fd1-acbf-c913f0cce37c"),
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9772),
                            IsDeleted = false,
                            ParentId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9774),
                            IsDeleted = false,
                            ParentId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9820),
                            IsDeleted = false,
                            ParentId = new Guid("00000000-0000-0000-0000-000000000000")
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9823),
                            IsDeleted = false,
                            ParentId = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.Subject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(447),
                            IsDeleted = false,
                            SubjectName = "Toan 10",
                            TotalSlots = 21
                        });
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.Teacher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9886),
                            IsDeleted = false
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9890),
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("Models.OfficeClassRobotic.BuisnessObject.TrungTamRobotic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(508),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("OfficeClassRobotic.BuisnessObject.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9693),
                            IsDeleted = false,
                            RoleName = "Student"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9697),
                            IsDeleted = false,
                            RoleName = "Parent"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9699),
                            IsDeleted = false,
                            RoleName = "Staff"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9702),
                            IsDeleted = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9704),
                            IsDeleted = false,
                            RoleName = "Teacher"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(9705),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("OfficeClassRobotic.BuisnessObject.Models.SubjectGradingWeight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(262),
                            IsDeleted = false,
                            SubjectID = new Guid("54eebe9e-2a5b-4a82-8522-1e7cd2aa4d57"),
                            WeightPercentage = 0
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 19, 2, 24, 19, 79, DateTimeKind.Local).AddTicks(267),
                            IsDeleted = false,
                            SubjectID = new Guid("54eebe9e-2a5b-4a82-8522-1e7cd2aa4d57"),
                            WeightPercentage = 0
                        });
